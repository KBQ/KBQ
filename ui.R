...
tagList(
  ...
  ui<- fluidPage(
    ...
    title = div(class="navbar-header",
                a("KBQ - {A Tool for Knowledge Base Quality Assessment Using Temporal Analysis}", href = "http://datascience.polito.it/shiny/KBQ/", class="navbar-brand")
    ...
    footer=p(hr(),p("ShinyApp created by ", strong("{Mohammad Rashid}")," of ",align="center",width=4),
             ...
             p(("Code available on Github:"),a("KBQ",href="https://github.com/KBQ/KBQ"),align="center",width=4)
